...
contract BicUnlockFactory {
    ...
    function createUnlock(address erc20, uint256 totalAmount, address beneficiaryAddress, uint64 durationSeconds, uint64 unlockRate, uint256 salt) public returns (BicUnlockTokenV2 ret) {
        ...
        ret = BicUnlockTokenV2(payable(new ERC1967Proxy{salt : bytes32(salt)}(
                ...
                abi.encodeCall(BicUnlockTokenV2.initialize, (erc20, totalAmount, beneficiaryAddress, durationSeconds, unlockRate)
            ))));
    ...
    function computeUnlock(address erc20, uint256 totalAmount, address beneficiaryAddress, uint64 durationSeconds, uint64 unlockRate, uint256 salt) public view returns (address) {
