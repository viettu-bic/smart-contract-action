 ...
 * Handles are formed by appending a local name to a namespace, separated by "/@". This contract allows minting and burning of handles, alongside basic management of their attributes.
